    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (isWork)
            {
                ...
                {
                    case "1":
                        conclusionAddDossier(ref fullNameArray, ref jobTitleArray);
                        break;
                    ...
                    case "3":
                        conclusionDeleteDossier(ref index, ref fullNameArray, ref jobTitleArray);
                        break;

                    case "4":
                        conclusionSearchLastName(ref fullNameArray, ref jobTitleArray);
                        break;
        ...
        static void DrawExit(ref bool isWork)
        {
        ...
        static void conclusionAddDossier(ref string[] fullNameArray, ref string[] jobTitleArray)
        {
        ...
        static void conclusionDeleteDossier(ref int index, ref string[] fullNameArray, ref string[] jobTitleArray)
        {
            index = GetIndex();
        ...
        static void conclusionSearchLastName(ref string[] fullNameArray, ref string[] jobTitleArray)
        {
            string foundDossier;
